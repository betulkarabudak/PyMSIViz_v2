...
def build_group_actions(self):
        ...
        self.cb2 = QComboBox()
        self.cb2.addItems(["nearest", "bilinear", "bicubic", "hanning"])
...
def build_group_roi(self):
        ...
        self.roiList.setMinimumHeight(90)
        lay.addWidget(self.roiList)
    
        lay.addWidget(QLabel("Volcano / ROI Compare Selection:"))
        rowAB = QHBoxLayout()
        rowAB.setSpacing(8)
        ...
        p.addWidget(self.btnVolcano,     2, 0)
        p.addWidget(self.btnROIcsv,      2, 1)
